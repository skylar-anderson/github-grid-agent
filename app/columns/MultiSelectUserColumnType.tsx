...
import { GridCell, MultiSelectUserCell, MultiSelectUserResponse } from '../actions';
...
export const MultiSelectUserColumnType: BaseColumnType<MultiSelectUserResponse> = {
  type: 'multi-select-user',
  renderCell: (cell: MultiSelectUserCell) => (
  ...
  buildHydrationPrompt: () => 'Select users: Select multiple users and reply only with their handles',
};