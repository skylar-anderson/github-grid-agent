...
export const MultiSelectColumnType: BaseColumnType<"multi-select"> = {
  type: "multi-select",
  ...
  renderCell: (cell: GridCell<"multi-select">) => (
  ...
  generateResponseSchema: (options?: Option[]) =>
    multiSelectSchema(options || []),
  buildHydrationPrompt: (cell: GridCell<"multi-select">) =>
  ...
  parseResponse: (responseContent: string): ColumnResponse["multi-select"] => {
