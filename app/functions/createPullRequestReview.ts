import { ReviewEvent, ReviewCommentType, createPullRequestReview } from '@/app/utils/github';
      ...
      comments: {
        ...
        items: {
          ...
          properties: {
            path: {
              type: 'string',
              description: 'The relative path to the file that necessitates the comment.',
            },
            position: {
              type: 'number',
