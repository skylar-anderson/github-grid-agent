...
const meta: OpenAI.FunctionDefinition = {
  ...
  parameters: {
    ...
    properties: {
      ...
      page: {
        type: 'number',
        description: 'Optional. Defaults to 1. The page of commits to return, defaults to 1',
      },
      sha: {
        type: 'string',
        description:
      ...
      path: {
        type: 'string',
        description: 'Optional. Only commits containing this file path will be returned.',
      },
      author: {
        type: 'string',
        description: 'Optional.GitHub login or email address by which to filter by commit author.',
      },
    },
    required: ['repository'],
  },
